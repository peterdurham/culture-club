...
// CONCATENATED MODULE: ./components/CreateBook.js
...
var CREATE_BOOK_MUTATION = external_graphql_tag_default()(_templateObject());

var CreateBook_CreateBook =
/*#__PURE__*/
function (_Component) {
  ...
  function CreateBook() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CreateBook)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(Form["a" /* default */], {
          ...
          htmlFor: "author"
        }, "Author", external_react_default.a.createElement("input", {
          type: "text",
          id: "author",
          name: "author",
          placeholder: "Author",
          required: true,
          value: _this2.state.author,
          onChange: _this2.handleChange
        })), external_react_default.a.createElement("label", {
          htmlFor: "year"
...
/* harmony default export */ var components_CreateBook = (CreateBook_CreateBook);

// EXTERNAL MODULE: ./components/PleaseSignIn.js
var PleaseSignIn = __webpack_require__(18);

// CONCATENATED MODULE: ./pages/add-book.js




var add_book_AddBookPage = function AddBookPage(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(components_CreateBook, null)));
};

/* harmony default export */ var add_book = __webpack_exports__["default"] = (add_book_AddBookPage);
